...
export const articlesSq: Record<string, ArticleSqOverlay> = {
  ...
  "successione-defunto-residente-estero": {
    ...
    body: [
      ...
      { type: "callout", tone: "warning", title: "Ku mbaron puna jonë", text: "Ne përgatisim dhe transmetojmë deklaratën dhe voltura mbi pasuritë në Itali. Nëse trashëgimia rregullohet nga ligj i huaj, nëse ka testament të huaj për ta vlerësuar ose certifikatë evropiane trashëgimi për ta marrë, nevojitet edhe noter ose avokat: jua themi në fillim, me emra dhe hapa, jo në mes të praktikës." },
  ...
  "documenti-esteri-successione-apostille": {
    ...
    body: [
      ...
      { type: "p", text: "Një testament i hartuar jashtë vendit zakonisht publikohet ose vlerësohet në Itali përmes noterit, me përkthim të betuar dhe, nëse nevojitet, legalizim. Është një nga pak hapat që kërkojnë profesionist tjetër nga ne: jua tregojmë menjëherë dhe koordinojmë deklaratën me afatet e tij." },
