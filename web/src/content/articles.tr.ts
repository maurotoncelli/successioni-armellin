...
export const articlesTr: Record<string, ArticleTrOverlay> = {
  ...
  "successione-defunto-residente-estero": {
    ...
    body: [
      ...
      { type: "callout", tone: "warning", title: "Bizim işimizin bittiği yer", text: "İtalya'daki mal varlığı için beyanı ve voltura'yı hazırlayıp iletiriz. Veraset yabancı hukuka tabiyse, yabancı vasiyetname geçerli kılınacaksa veya Avrupa veraset belgesi alınacaksa noter veya avukat da gerekir: belgelerden anlaşıldığı anda size bildiririz ve adımları açıklarız." },
  ...
  "documenti-esteri-successione-apostille": {
    ...
    body: [
      ...
      { type: "p", text: "Yurt dışında düzenlenen vasiyetname genelde noter aracılığıyla İtalya'da ilan edilir veya geçerli kılınır; yeminli tercüme ve gerekiyorsa legalizasyon ile. Bizden farklı profesyonel gerektiren az adımdan biridir: sizi yönlendiririz ve beyanı onların süreleriyle koordine ederiz." },
