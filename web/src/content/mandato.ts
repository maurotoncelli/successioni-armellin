...
export function buildMandatoParagraphs({
  ...
  return [
    ...
    "4. DILIGENZA E RESPONSABILITA. Il Professionista esegue l'incarico con la diligenza professionale richiesta dalla natura dell'attivita (obbligazione di mezzi), avvalendosi della supervisione fiscale di un commercialista. Per quanto non previsto dal presente mandato si applicano le Condizioni di vendita accettate in fase di acquisto, incluse le previsioni su limitazioni di responsabilita, modifica del pacchetto e conguaglio.",

    "5. RECESSO. Resta fermo il diritto di recesso di cui agli artt. 52-59 del Codice del Consumo, secondo quanto indicato nelle Condizioni di vendita e nella pagina Recesso del sito. In caso di recesso dopo l'avvio della lavorazione, il Cliente corrisponde un importo proporzionale al servizio gia reso.",
