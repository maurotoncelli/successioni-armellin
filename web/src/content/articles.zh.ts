...
export const articlesZh: Record<string, ArticleZhOverlay> = {
  ...
  "eredi-estero": {
    ...
    body: [
      ...
      { type: "p", text: "遗产继承申报不是公证文书，也不需要公证人。放弃继承、附清单利益接受继承、公布遗嘱及出售继承房产，则需要公证人，或意大利领事馆（对意大利公民履行部分公证职能）。若从文件中看出您的案件需要这些，我们会告知您并说明应联系哪类专业人士。" },
      { type: "h2", text: "费用多少" },
  ...
  "successione-defunto-residente-estero": {
    ...
    body: [
      ...
      { type: "callout", tone: "warning", title: "我们工作的边界", text: "我们为意大利境内的财产准备并传输申报及 voltura（地籍过户）。若继承受外国法管辖、有外国遗嘱须执行或须取得欧洲继承证书，还需要公证人或律师：一旦从文件中看出，我们会告知您并说明步骤。" },
      { type: "h2", text: "额外文件" },
      {
        type: "ul",
        items: [
  ...
  "documenti-esteri-successione-apostille": {
    ...
    body: [
      ...
      { type: "h2", text: "外国遗嘱" },
      { type: "p", text: "在国外订立的遗嘱通常须在意大利通过公证人公布或执行，附 sworn 翻译及必要时认证。这是少数需要我们以外专业人士的步骤之一：我们会为您指明并协调申报与其时间安排。" },
