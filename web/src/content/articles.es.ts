...
export const articlesEs: Record<string, ArticleEsOverlay> = {
  ...
  "eredi-estero": {
    ...
    body: [
      ...
      { type: "p", text: "La declaración de sucesión no es un acto notarial y no lo exige. Sí hacen falta un notario, o el consulado italiano que para los ciudadanos italianos desempeña algunas funciones notariales, para renunciar a la herencia, aceptarla con beneficio de inventario, publicar un testamento y vender el inmueble heredado. Si tu caso lo prevé, te lo decimos antes, no después." },
